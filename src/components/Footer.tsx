      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-300 hover:text-purple-400">Notre mission</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-purple-400">Comment adopter</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-purple-400">Conseils d'adoption</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-purple-400">Blog</a>
              </li>
            </ul>
          </div>
